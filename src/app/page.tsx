...
export default function Home() {
  ...
  return <div className="site-shell"><SiteHeader /><main id="main-content">
    ...
    <section className="nws-reviews reveal" id="reviews"><div className="nws-reviews-inner"><div className="nws-reviews-head"><span className="nws-pill-badge">Client feedback</span><h2 className="nws-reviews-title">Check what our clients are saying</h2><p className="nws-reviews-sub">Don’t take our word for it</p></div><div className="nws-reviews-grid">
      <div className="nws-rev-col reveal-item">
        <figure className="nws-review-card"><span className="nws-avatar" aria-hidden="true">{testimonials[0].author.charAt(0)}</span><figcaption><b>{testimonials[0].author}</b><small>Google Review</small></figcaption><span className="stars" aria-label="Rated 5 out of 5 stars">★★★★★</span><blockquote>“{testimonials[0].quote}”</blockquote></figure>
        <figure className="nws-review-card nws-review-photo"><img src="/assets/reference/1st-Texas-Realtors-Team2.png" alt="The 1st Texas Realtors team with happy clients" loading="lazy" /><figcaption><b>Our clients</b><small>Across Clear Lake NASA</small></figcaption><span className="stars" aria-label="Rated 5 out of 5 stars">★★★★★</span></figure>
      </div>
      <div className="nws-rev-col nws-rev-col-mid reveal-item">
        <figure className="nws-review-card"><span className="nws-avatar" aria-hidden="true">{testimonials[1].author.charAt(0)}</span><figcaption><b>{testimonials[1].author}</b><small>Google Review</small></figcaption><span className="stars" aria-label="Rated 5 out of 5 stars">★★★★★</span><blockquote>“{testimonials[1].quote}”</blockquote></figure>
      </div>
      <div className="nws-rev-col reveal-item">
        <figure className="nws-review-card"><span className="nws-avatar" aria-hidden="true">{testimonials[2].author.charAt(0)}</span><figcaption><b>{testimonials[2].author}</b><small>Google Review</small></figcaption><span className="stars" aria-label="Rated 5 out of 5 stars">★★★★★</span><blockquote>“{testimonials[2].quote}”</blockquote></figure>
        <figure className="nws-review-card nws-review-photo"><img src="/assets/reference/leaguecityhomesforsale.jpg" alt="A home sold by 1st Texas Realtors" loading="lazy" /><figcaption><b>Happy homeowners</b><small>League City, TX</small></figcaption><span className="stars" aria-label="Rated 5 out of 5 stars">★★★★★</span></figure>
      </div>
    </div><Link className="nws-reviews-cta" href="/realtor-reviews/">Read all testimonials <span>→</span></Link></div></section>
