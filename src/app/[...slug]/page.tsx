...
export default async function Page({ params }: { params: Promise<{ slug: string[] }> }) {
  ...
  if (key === 'realtor-reviews') return <PageFrame eyebrow="Clear Lake Tx Realtor Reviews" title="1st Texas Realtors in Clear Lake" intro="The experience and expertise of 1st Texas Realtors made the buying experience easy to navigate and gave me confidence through the entire process."><StickyReviews /></PageFrame>
