  ...
  return <>
    ...
    <header className={`site-header ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-wrap">
        ...
        <Link href="/" onClick={closeMenu} className="header-logo" aria-label="1st Texas Realtors"><img src="/assets/reference/1stTexasRealtors-logo-clear.png" alt="1st TEXAS REALTORS — Full Service Brokerage" width={152} height={73} /></Link>
