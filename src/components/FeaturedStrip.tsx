...
const mapnote = 'Seabrook Quadrangle · USGS · Surveyed 1915–1920'
...
export function FeaturedStrip() {
  ...
  return <section className={`press-row${visible ? ' is-visible' : ''}`} ref={ref as never} aria-label="Featured in">
    ...
    <div className="press-items">
      ...
      <span className="press-mapnote" style={{ transitionDelay: visible ? `${0.45 + featured.length * 0.55}s` : undefined }}>{mapnote}</span>
    </div>
  </section>
}
